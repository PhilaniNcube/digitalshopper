...
import { clearCart, totalCartItems, totalCartPrice } from "@/store/features/cartSlice";
import formatter from "@/lib/currency";
import { PayfastData } from "@/interfaces";
...
const CheckoutForm = () => {
  ...
  const submitForm = () => {
    ...
    let x = payfastFormRef.current?.attributes;
    ...
    <>
      {newOrder && (
        ...
        >
          ...
          />
          <input type="hidden" name="name_first" value={newOrder.first_name} />
