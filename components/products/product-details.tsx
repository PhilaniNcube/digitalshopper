    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-10 lg:px-8">
      ...
      {product.descriptionHtml && (
        <section className="mt-16">
          ...
          <div
            className="prose prose-invert prose-sm max-w-none prose-headings:font-display prose-headings:tracking-tight prose-p:text-slate-400 prose-a:text-primary-strong prose-strong:text-white"
